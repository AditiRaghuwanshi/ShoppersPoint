    ...
    <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-lg w-full text-center flex flex-col items-center gap-6">
        ...
        <div className="relative">
          <div className="w-48 h-48 rounded-full bg-purple-50 flex items-center justify-center border-4 border-dashed border-purple-200">
            <div className="relative">
              <svg
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full">
          <Link
            to="/"
            className="flex-1 w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 active:scale-95 text-white text-sm font-semibold py-3 px-6 rounded-xl transition-all duration-150 shadow-md shadow-purple-100"
          >
