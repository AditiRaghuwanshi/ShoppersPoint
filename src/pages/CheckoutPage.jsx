        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handlePlaceOrder} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              <button
                type="submit"
                className="mt-6 w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 active:scale-95 text-white font-semibold py-3 rounded-xl transition-all shadow-md shadow-purple-100"
              >
                Place Order
