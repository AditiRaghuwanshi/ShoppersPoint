    ...
    <div className="flex items-center gap-4 bg-white border border-gray-100 rounded-2xl p-4 shadow-sm">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <button
          ...
          className="w-7 h-7 rounded-lg border border-gray-200 text-gray-500 hover:bg-purple-50 hover:text-purple-700 hover:border-purple-200 flex items-center justify-center transition text-lg font-bold"
        >
          +
        </button>
      </div>
