      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        ...
        <div className="flex gap-2 mt-auto pt-1">
          <button 
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 active:scale-95 text-white text-sm font-semibold py-2.5 px-4 rounded-xl transition-all duration-150 shadow-md shadow-purple-100"
          >
